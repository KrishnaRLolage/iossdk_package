...
/** @brief Deprecated, using this value will have no effect
 *	@deprecated This is the default voice used for TTS if no speaking voice is specified by your integration.
 */
