...
/** @brief Controller managing the voice user interface (VUI) attached to a graphical user interface (GUI)
	...
	@xmlonly<nmFramework>%DOC_BRANDING%</nmFramework>@endxmlonly
	@since 1.3
 ...
 */
@property (nonatomic, retain) NUSASpeechView* speechView __attribute__((deprecated));
...
/** @brief Deprecated, setting this property will have no effect.
 @since 1.6
 @deprecated As of release 3.4R3
 ...
 */
@property (nonatomic, retain) UIImage* volumeMeterTooLoudImage __attribute__((deprecated));
...
/** @brief Deprecated, setting this property will have no effect.
 ...
 A custom image is resized to a height of 150 or 40, preserving the aspect ratio.
 */
@property (nonatomic, retain) UIImage* volumeMeterTooSoftImage __attribute__((deprecated));
...
/** @brief Deprecated, setting this property will have no effect.
 ...
 A custom image is resized to a height of 150 or 40, preserving the aspect ratio.
 */
@property (nonatomic, retain) UIImage* volumeMeterTooNoisyImage __attribute__((deprecated));
...
@property (nonatomic, assign) NUSABadQualityIndicatorLocation badQualityIndicatorLocation __attribute__((deprecated));
...
/** @brief This method is deprecated.
    @deprecated As of release 3.3
 
    @param value Filter key.
    @param key Filter value.
*/
- (void) addFilter: (NSString *)value forKey: (NSString *)key __attribute__((deprecated));
